...
Function `santosT()` returns a `numeric` `vector` of distribution free test statistic (@eq-santosT), with `attributes`,

-   `attr(.,'delta')`, $\bar{x}_1 - c\bar{x}_0$, i.e., the numerator of (@eq-santosT),
-   `attr(.,'stderr')`, standard error $s_{\bar\Delta}$, i.e., the denominator of (@eq-santosT),
